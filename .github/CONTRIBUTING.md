...
1. [Create a fork](https://help.github.com/articles/fork-a-repo) of the upstream
   repository
   at [`Maastricht University/rdfsolve`](https://github.com/Maastricht University/rdfsolve)
   on your GitHub account (or in one of your organizations)
2. [Clone your fork](https://docs.github.com/en/repositories/creating-and-managing-repositories/cloning-a-repository)
   with `git clone https://github.com/<your namespace here>/rdfsolve.git`
...
```shell
$ git remote add Maastricht University https://github.com/Maastricht University/rdfsolve.git
```
