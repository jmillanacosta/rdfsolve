...
class VoidSchema(BaseModel):
    ...
    def get_properties(self) -> List[str]:
        ...
        return sorted(list(set(t.property for t in self.triples)))
    
    def get_class_properties(self, class_name: str) -> List[str]:
        """Get all properties used by a specific class."""
        return sorted(list(set(
            t.property for t in self.triples 
            if t.subject_class == class_name
        )))
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        return {
            "triples": [
                [t.subject_uri, t.property_uri, t.object_uri] 
