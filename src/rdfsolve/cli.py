...
@click.option("--no-counts", is_flag=True,
              help="Skip COUNT aggregations for faster discovery")
@click.option("--sample-limit", type=int,
              help="Limit results for faster sampling")
def analyze(endpoint, graph_uri, dataset_name, void_iri, output_dir,
            no_counts, sample_limit):
